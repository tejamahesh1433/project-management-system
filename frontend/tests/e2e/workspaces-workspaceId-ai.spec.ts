...
import { WorkspacesAiPage } from './pages/WorkspacesAiPage';

test.describe('/workspaces/[workspaceId]/ai', () => {

  test('loads successfully', async ({ page }) => {
    await page.goto('/workspaces/test-id/ai');
    await expect(page).toHaveURL(//workspaces/workspaceId\.\*/ai/);
